...
function Loot({
  ...
  function takeOne(idx) {
    if (!open) return;
    window.GameBridge.emit("loot:take", {
      crateId: open.id,
      idx
    });
  }
  function takeAll() {
    if (!open) return;
    window.GameBridge.emit("loot:takeAll", {
      crateId: open.id
    });
  }
  if (!open) return null;
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, contents.length, " STACK", contents.length !== 1 ? "S" : "")), contents.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "mono dim",
    style: {
      fontSize: 12,
      padding: "30px 0",
    ...
    className: "kbd"
  }, "CLICK"), " TAKE ONE STACK\xA0\xA0\xA0", /*#__PURE__*/React.createElement("span", {
    className: "kbd"
  }, "ESC"), " CLOSE"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 10
    }
    ...
    style: {
      ...
      padding: 12,
      fontSize: 13,
      opacity: contents.length === 0 ? 0.5 : 1
    }
  }, "\u25B6 TAKE EVERYTHING"), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    onClick: doClose,
    style: {
      padding: 12,
