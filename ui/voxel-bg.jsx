...
function VoxelBG({ paused = false }) {
  ...
  const structures = [
    { left: 18, bottom: 24, w: 80, h: 80, depth: 80, opacity: 0.85 },
    { left: 70, bottom: 28, w: 60, h: 110, depth: 60, opacity: 0.78 },
    { left: 38, bottom: 18, w: 50, h: 50, depth: 50, opacity: 0.7 },
    { left: 52, bottom: 14, w: 35, h: 35, depth: 35, opacity: 0.55 },
    { left: 85, bottom: 16, w: 40, h: 60, depth: 40, opacity: 0.55 },
    { left: 8, bottom: 14, w: 30, h: 30, depth: 30, opacity: 0.5 },
  ];

  return (
    <div className="vx-stage">
      <div className="vx-moon" />
      <div className="vx-sway" style={{ position: "absolute", inset: 0 }}>
        <div className="vx-floor" />
        {/* Block silhouettes — approximated as flat faces stacked */}
        {structures.map((s, i) => (
          <VxBlock key={i} {...s} />
        ))}
      </div>
      <div className="vx-fog" />
      <div className="vx-rain" />
      <div className="vx-crosshair" />
      <div className="vx-hand">
...
function VxBlock({ left, bottom, w, h, depth, opacity }) {
